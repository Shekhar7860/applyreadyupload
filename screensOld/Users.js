...
const advert = firebase.admob().interstitial('ca-app-pub-3550043356338169/9640453662')
...
export default class Users extends Component {
 ...
 setTimeout(() => {
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container} >
       ...
       <TouchableOpacity onPress={() => this.goBack()}>
                    ...
                    <Text style={styles.toolbarTitle}>Vestige Products</Text>
    ...
    size={"LARGE_BANNER"}
  unitId={"ca-app-pub-3550043356338169/5154413749"}
