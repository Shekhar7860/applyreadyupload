      ...
      <View style={{flex:1}}>
         ...
         <TouchableOpacity >
               ...
               />
                ...
                onSubmitEditing={() => { this.sevnthTextInput.focus(); }}
                placeholderTextColor = "#95A5A6"
                selectionColor="#fff"
                keyboardType="number-pad"
                ...
                ref={(input) => { this.sevnthTextInput = input; }}
                onSubmitEditing={() => { this.egthTextInput.focus(); }}
                placeholderTextColor = "#95A5A6"
                selectionColor="#fff"
                keyboardType="number-pad"
                ...
                ref={(input) => { this.egthTextInput = input; }}
               ...
               underlineColorAndroid='rgba(0,0,0,0)'
               ref={(input) => { this.eleventhTextInput = input; }}
                onSubmitEditing={() => { this.twelthTextInput.focus(); }} 
               ...
               <View style={{flexDirection:'row',  borderWidth : 1, width:'80%', backgroundColor : '#ffffff', borderRadius:100, marginTop:10}}>
                ...
                underlineColorAndroid='rgba(0,0,0,0)' 
                placeholder="Physics"
                ref={(input) => { this.twelthTextInput = input; }}
                ...
                ref={(input) => { this.thirteenthTextInput = input; }}
                placeholderTextColor = "#95A5A6"
                selectionColor="#fff"
                keyboardType="number-pad"
